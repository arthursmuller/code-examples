...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230405152827_Added TotalOverdrawnAmount ApplicationUser")]
    partial class AddedTotalOverdrawnAmountApplicationUser
    {
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 4, 5, 12, 28, 26, 761, DateTimeKind.Unspecified).AddTicks(8495),
                            UpdateDate = new DateTime(2023, 4, 5, 12, 28, 26, 752, DateTimeKind.Unspecified).AddTicks(1015)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 4, 5, 12, 28, 26, 762, DateTimeKind.Unspecified).AddTicks(623),
                            UpdateDate = new DateTime(2023, 4, 5, 12, 28, 26, 762, DateTimeKind.Unspecified).AddTicks(568)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "84509848072",
                            CreatedDate = new DateTime(2023, 4, 5, 12, 28, 26, 762, DateTimeKind.Unspecified).AddTicks(648),
                            UpdateDate = new DateTime(2023, 4, 5, 12, 28, 26, 762, DateTimeKind.Unspecified).AddTicks(636)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 4, 5, 12, 28, 26, 762, DateTimeKind.Unspecified).AddTicks(672),
                            UpdateDate = new DateTime(2023, 4, 5, 12, 28, 26, 762, DateTimeKind.Unspecified).AddTicks(660)
                        });
                });
