...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230323025353_Added BirthDate Props")]
    partial class AddedBirthDateProps
    {
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 3, 22, 23, 53, 52, 137, DateTimeKind.Unspecified).AddTicks(1575),
                            UpdateDate = new DateTime(2023, 3, 22, 23, 53, 52, 128, DateTimeKind.Unspecified).AddTicks(7248)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 3, 22, 23, 53, 52, 137, DateTimeKind.Unspecified).AddTicks(5155),
                            UpdateDate = new DateTime(2023, 3, 22, 23, 53, 52, 137, DateTimeKind.Unspecified).AddTicks(5064)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "84509848072",
                            CreatedDate = new DateTime(2023, 3, 22, 23, 53, 52, 137, DateTimeKind.Unspecified).AddTicks(5179),
                            UpdateDate = new DateTime(2023, 3, 22, 23, 53, 52, 137, DateTimeKind.Unspecified).AddTicks(5168)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 3, 22, 23, 53, 52, 137, DateTimeKind.Unspecified).AddTicks(5201),
                            UpdateDate = new DateTime(2023, 3, 22, 23, 53, 52, 137, DateTimeKind.Unspecified).AddTicks(5190)
                        });
                });
