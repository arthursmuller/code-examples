...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230219153408_Added QuodDataRecords")]
    partial class AddedQuodDataRecords
    {
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 2, 19, 12, 34, 7, 88, DateTimeKind.Unspecified).AddTicks(941),
                            UpdateDate = new DateTime(2023, 2, 19, 12, 34, 7, 75, DateTimeKind.Unspecified).AddTicks(8727)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 2, 19, 12, 34, 7, 88, DateTimeKind.Unspecified).AddTicks(2879),
                            UpdateDate = new DateTime(2023, 2, 19, 12, 34, 7, 88, DateTimeKind.Unspecified).AddTicks(2825)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "40755899008",
                            CreatedDate = new DateTime(2023, 2, 19, 12, 34, 7, 88, DateTimeKind.Unspecified).AddTicks(2905),
                            UpdateDate = new DateTime(2023, 2, 19, 12, 34, 7, 88, DateTimeKind.Unspecified).AddTicks(2893)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 2, 19, 12, 34, 7, 88, DateTimeKind.Unspecified).AddTicks(2928),
                            UpdateDate = new DateTime(2023, 2, 19, 12, 34, 7, 88, DateTimeKind.Unspecified).AddTicks(2917)
                        });
                });
