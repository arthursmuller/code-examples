...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230404221715_AddedScoreFilterHistoryTable")]
    partial class AddedScoreFilterHistoryTable
    {
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 4, 4, 19, 17, 14, 363, DateTimeKind.Unspecified).AddTicks(1568),
                            UpdateDate = new DateTime(2023, 4, 4, 19, 17, 14, 353, DateTimeKind.Unspecified).AddTicks(6089)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 4, 4, 19, 17, 14, 363, DateTimeKind.Unspecified).AddTicks(3062),
                            UpdateDate = new DateTime(2023, 4, 4, 19, 17, 14, 363, DateTimeKind.Unspecified).AddTicks(3025)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "84509848072",
                            CreatedDate = new DateTime(2023, 4, 4, 19, 17, 14, 363, DateTimeKind.Unspecified).AddTicks(3082),
                            UpdateDate = new DateTime(2023, 4, 4, 19, 17, 14, 363, DateTimeKind.Unspecified).AddTicks(3073)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 4, 4, 19, 17, 14, 363, DateTimeKind.Unspecified).AddTicks(3102),
                            UpdateDate = new DateTime(2023, 4, 4, 19, 17, 14, 363, DateTimeKind.Unspecified).AddTicks(3092)
                        });
                });
