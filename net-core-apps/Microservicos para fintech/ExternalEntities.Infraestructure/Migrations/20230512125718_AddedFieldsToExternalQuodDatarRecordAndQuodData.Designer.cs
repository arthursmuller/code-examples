...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230512125718_AddedFieldsToExternalQuodDatarRecordAndQuodData")]
    partial class AddedFieldsToExternalQuodDatarRecordAndQuodData
    {
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 5, 12, 9, 57, 18, 272, DateTimeKind.Unspecified).AddTicks(6458),
                            UpdateDate = new DateTime(2023, 5, 12, 9, 57, 18, 263, DateTimeKind.Unspecified).AddTicks(4515)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 5, 12, 9, 57, 18, 272, DateTimeKind.Unspecified).AddTicks(7680),
                            UpdateDate = new DateTime(2023, 5, 12, 9, 57, 18, 272, DateTimeKind.Unspecified).AddTicks(7650)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "84509848072",
                            CreatedDate = new DateTime(2023, 5, 12, 9, 57, 18, 272, DateTimeKind.Unspecified).AddTicks(7693),
                            UpdateDate = new DateTime(2023, 5, 12, 9, 57, 18, 272, DateTimeKind.Unspecified).AddTicks(7687)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 5, 12, 9, 57, 18, 272, DateTimeKind.Unspecified).AddTicks(7705),
                            UpdateDate = new DateTime(2023, 5, 12, 9, 57, 18, 272, DateTimeKind.Unspecified).AddTicks(7699)
                        });
                });
