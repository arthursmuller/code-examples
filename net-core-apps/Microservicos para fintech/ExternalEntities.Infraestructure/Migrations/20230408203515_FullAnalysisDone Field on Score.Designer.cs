...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230408203515_FullAnalysisDone Field on Score")]
    partial class FullAnalysisDoneFieldonScore
    {
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 4, 8, 17, 35, 14, 639, DateTimeKind.Unspecified).AddTicks(4947),
                            UpdateDate = new DateTime(2023, 4, 8, 17, 35, 14, 630, DateTimeKind.Unspecified).AddTicks(212)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 4, 8, 17, 35, 14, 639, DateTimeKind.Unspecified).AddTicks(6555),
                            UpdateDate = new DateTime(2023, 4, 8, 17, 35, 14, 639, DateTimeKind.Unspecified).AddTicks(6505)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "84509848072",
                            CreatedDate = new DateTime(2023, 4, 8, 17, 35, 14, 639, DateTimeKind.Unspecified).AddTicks(6579),
                            UpdateDate = new DateTime(2023, 4, 8, 17, 35, 14, 639, DateTimeKind.Unspecified).AddTicks(6568)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 4, 8, 17, 35, 14, 639, DateTimeKind.Unspecified).AddTicks(6599),
                            UpdateDate = new DateTime(2023, 4, 8, 17, 35, 14, 639, DateTimeKind.Unspecified).AddTicks(6590)
                        });
                });
