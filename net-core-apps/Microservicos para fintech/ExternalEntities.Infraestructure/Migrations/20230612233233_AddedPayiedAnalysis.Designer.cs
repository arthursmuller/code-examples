...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230612233233_AddedPayiedAnalysis")]
    partial class AddedPayiedAnalysis
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.BusinessAggregate.AnalysisRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.CreditScoringAggregate.UserScore", b =>
                {
                    ...
                    b.Property<bool>("FullAnalysisDone")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.Property<decimal?>("TotalExternalCreditAvailable")
                        .HasColumnType("decimal(65,30)");

                    b.Property<int?>("TotalFinancialOperations")
                        .HasColumnType("int");

                    b.Property<decimal?>("TotalOverdrawnAmount")
                        .HasColumnType("decimal(65,30)");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 6, 12, 20, 32, 32, 979, DateTimeKind.Unspecified).AddTicks(386),
                            UpdateDate = new DateTime(2023, 6, 12, 20, 32, 32, 975, DateTimeKind.Unspecified).AddTicks(9675)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 6, 12, 20, 32, 32, 979, DateTimeKind.Unspecified).AddTicks(1481),
                            UpdateDate = new DateTime(2023, 6, 12, 20, 32, 32, 979, DateTimeKind.Unspecified).AddTicks(1451)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "84509848072",
                            CreatedDate = new DateTime(2023, 6, 12, 20, 32, 32, 979, DateTimeKind.Unspecified).AddTicks(1494),
                            UpdateDate = new DateTime(2023, 6, 12, 20, 32, 32, 979, DateTimeKind.Unspecified).AddTicks(1488)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 6, 12, 20, 32, 32, 979, DateTimeKind.Unspecified).AddTicks(1506),
                            UpdateDate = new DateTime(2023, 6, 12, 20, 32, 32, 979, DateTimeKind.Unspecified).AddTicks(1500)
                        });
                });

            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.BusinessAggregate.AnalysisRequest", b =>
                {
                    b.HasOne("ExternalEntities.Domain.AggregatesModel.BusinessAggregate.Business", "Business")
                        .WithMany("PayiedAnalysisRequests")
                            ...
                            b1.OwnsOne("ExternalEntities.Domain.AggregatesModel.CreditScoringAggregate.ExternalQuodData", "ExternalQuodData", b2 =>
                                {
                                    ...
                                    b2.Property<bool?>("PublicExposed")
                                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.BusinessAggregate.Business", b =>
                {
                    b.Navigation("PayiedAnalysisRequests");
