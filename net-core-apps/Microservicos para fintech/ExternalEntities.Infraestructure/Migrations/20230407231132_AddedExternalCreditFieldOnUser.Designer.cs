...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230407231132_AddedExternalCreditFieldOnUser")]
    partial class AddedExternalCreditFieldOnUser
    {
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 4, 7, 20, 11, 31, 270, DateTimeKind.Unspecified).AddTicks(5699),
                            UpdateDate = new DateTime(2023, 4, 7, 20, 11, 31, 263, DateTimeKind.Unspecified).AddTicks(4615)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 4, 7, 20, 11, 31, 270, DateTimeKind.Unspecified).AddTicks(8571),
                            UpdateDate = new DateTime(2023, 4, 7, 20, 11, 31, 270, DateTimeKind.Unspecified).AddTicks(8470)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "84509848072",
                            CreatedDate = new DateTime(2023, 4, 7, 20, 11, 31, 270, DateTimeKind.Unspecified).AddTicks(8595),
                            UpdateDate = new DateTime(2023, 4, 7, 20, 11, 31, 270, DateTimeKind.Unspecified).AddTicks(8586)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 4, 7, 20, 11, 31, 270, DateTimeKind.Unspecified).AddTicks(8614),
                            UpdateDate = new DateTime(2023, 4, 7, 20, 11, 31, 270, DateTimeKind.Unspecified).AddTicks(8604)
                        });
                });
