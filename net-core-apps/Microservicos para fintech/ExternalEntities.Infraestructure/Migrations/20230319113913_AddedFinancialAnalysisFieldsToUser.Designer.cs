...
namespace ExternalEntities.Infraestructure.Migrations
{
    ...
    [Migration("20230319113913_AddedFinancialAnalysisFieldsToUser")]
    partial class AddedFinancialAnalysisFieldsToUser
    {
            ...
            modelBuilder.Entity("ExternalEntities.Domain.AggregatesModel.UserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "02981603078",
                            CreatedDate = new DateTime(2023, 3, 19, 8, 39, 12, 490, DateTimeKind.Unspecified).AddTicks(3140),
                            UpdateDate = new DateTime(2023, 3, 19, 8, 39, 12, 485, DateTimeKind.Unspecified).AddTicks(2684)
                        },
                        new
                        {
                            Id = 2,
                            Cpf = "77735936044",
                            CreatedDate = new DateTime(2023, 3, 19, 8, 39, 12, 490, DateTimeKind.Unspecified).AddTicks(4783),
                            UpdateDate = new DateTime(2023, 3, 19, 8, 39, 12, 490, DateTimeKind.Unspecified).AddTicks(4732)
                        },
                        new
                        {
                            Id = 3,
                            Cpf = "84509848072",
                            CreatedDate = new DateTime(2023, 3, 19, 8, 39, 12, 490, DateTimeKind.Unspecified).AddTicks(4824),
                            UpdateDate = new DateTime(2023, 3, 19, 8, 39, 12, 490, DateTimeKind.Unspecified).AddTicks(4813)
                        },
                        new
                        {
                            Id = 4,
                            Cpf = "71096627051",
                            CreatedDate = new DateTime(2023, 3, 19, 8, 39, 12, 490, DateTimeKind.Unspecified).AddTicks(4844),
                            UpdateDate = new DateTime(2023, 3, 19, 8, 39, 12, 490, DateTimeKind.Unspecified).AddTicks(4834)
                        });
                });
