...
{
    public partial class AddRendimentos : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_RENDIMENTO_CLIENTE = table.Column<int>(nullable: false)
                    ...
                    ID_UF = table.Column<int>(nullable: false),
                    ID_BANCO = table.Column<int>(nullable: false),
                    ID_TIPO_CONTA = table.Column<int>(nullable: false),
                    AGENCIA = table.Column<string>(unicode: false, maxLength: 15, nullable: false),
                    CONTA = table.Column<string>(unicode: false, maxLength: 15, nullable: false),
                    VALOR_RENDIMENTO = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_RENDIMENTO_CLIENTE_INSS = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    USUARIO_ATUALIZACAO = table.Column<string>(unicode: false, maxLength: 10, nullable: true),
                    DATA_ATUALIZACAO = table.Column<DateTime>(nullable: false),
                    ID_RENDIMENTO_CLIENTE = table.Column<int>(nullable: false),
                    ID_INSS_ESPECIE_BENEFICIO = table.Column<int>(nullable: false),
                    MATRICULA = table.Column<string>(unicode: false, maxLength: 20, nullable: false),
                    DATA_INSCRICAO = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RENDIMENTO_CLIENTE_INSS", x => x.ID_RENDIMENTO_CLIENTE_INSS);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_RENDIMENTO_CLIENTE_SIAPE = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    USUARIO_ATUALIZACAO = table.Column<string>(unicode: false, maxLength: 10, nullable: true),
                    DATA_ATUALIZACAO = table.Column<DateTime>(nullable: false),
                    ID_RENDIMENTO_CLIENTE = table.Column<int>(nullable: false),
                    ...
                    MATRICULA = table.Column<string>(unicode: false, maxLength: 20, nullable: false),
                    MATRICULA_INSTITUIDOR = table.Column<string>(unicode: false, maxLength: 20, nullable: true),
                    POSSUI_REPRESENTACAO_POR_PROCURADOR = table.Column<bool>(nullable: false),
                    DATA_ADMISSAO = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RENDIMENTO_CLIENTE_SIAPE", x => x.ID_RENDIMENTO_CLIENTE_SIAPE);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RENDIMENTO_CLIENTE_INSS_ID_RENDIMENTO_CLIENTE",
                table: "RENDIMENTO_CLIENTE_INSS",
                column: "ID_RENDIMENTO_CLIENTE",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RENDIMENTO_CLIENTE_SIAPE_ID_RENDIMENTO_CLIENTE",
