...
namespace Repositorio.Migrations
{
    ...
    [Migration("20220328152745_AddSeguroAndNovasMensagensAndBiometriaUpdates")]
    partial class AddSeguroAndNovasMensagensAndBiometriaUpdates
    {
            ...
            modelBuilder.Entity("Dominio.SeguroProdutoIcatuDominio", b =>
                {
                    ...
                    b.Property<int>("GrupoApolice")
                        .HasColumnType("int")
                        .HasColumnName("GRUPO_APOLICE");
            ...
            modelBuilder.Entity("Dominio.SeguroPropostaIcatuDominio", b =>
                {
                    ...
                    b.HasIndex("IdSeguroClienteIcatu")
                        .IsUnique()
                        .HasFilter("[ID_SEGURO_CLIENTE_ICATU] IS NOT NULL");
            ...
            modelBuilder.Entity("Dominio.RegistroBiometriaUnicoDominio", b =>
                {
                    b.HasOne("Dominio.ClienteDominio", "Cliente")
                        .WithOne()
                        .HasForeignKey("Dominio.RegistroBiometriaUnicoDominio", "IdCliente")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dominio.SeguroPropostaIcatuDominio", b =>
                {
                    ...
                    b.HasOne("Dominio.SeguroPropostaDominio", "SeguroProposta")
                        .WithOne()
                        .HasForeignKey("Dominio.SeguroPropostaIcatuDominio", "IdSeguroClienteIcatu");
