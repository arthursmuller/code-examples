...
namespace Repositorio.Migrations
{
    ...
    [Migration("20210201121811_TemplateEmail")]
            ...
            modelBuilder.Entity("Dominio.TemplateEmailFinalidadeDominio", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 0,
                            DataAtualizacao = new DateTime(2021, 2, 1, 9, 18, 11, 146, DateTimeKind.Local).AddTicks(5820),
                            Descricao = "Default"
                        },
                        new
                        {
                            ID = 1,
                            DataAtualizacao = new DateTime(2021, 2, 1, 9, 18, 11, 146, DateTimeKind.Local).AddTicks(6380),
                            Descricao = "RecuperacaoSenha"
                        });
                });
            ...
            modelBuilder.Entity("Dominio.TemplateEmailTipoDominio", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 0,
                            DataAtualizacao = new DateTime(2021, 2, 1, 9, 18, 11, 128, DateTimeKind.Local).AddTicks(210),
                            Descricao = "Content"
                        },
                        new
                        {
                            ID = 1,
                            DataAtualizacao = new DateTime(2021, 2, 1, 9, 18, 11, 143, DateTimeKind.Local).AddTicks(8020),
                            Descricao = "Header"
                        },
                        new
                        {
                            ID = 2,
                            DataAtualizacao = new DateTime(2021, 2, 1, 9, 18, 11, 143, DateTimeKind.Local).AddTicks(8300),
                            Descricao = "Footer"
                        });
                });
