    ...
    <>
      ...
      >
        <Text color="#00c3af" m="0px 0px 0px 2%">
          ...
          <FormattedMessage id="block_application.success" />
        </Text>
        <CloseIcon
          boxSize={4}
      ...
      >
        ...
        <Box alignSelf="center">
          ...
          >
            <FormattedMessage id="block_application.apply_rule" />
          </Button>
          <Button colorScheme="blue" h="45px" w="176px">
            <Link to="/android/block-app/register-general">
              <FormattedMessage id="block_application.add_rule" />
            </Link>
          </Button>
        </Box>
      </Box>
                      ...
                      <Menu placement="top" onClose={() => changeColor(-1)}>
                        ...
                        <MenuList>
                          <MenuItem fontSize="sm">
                            <Link to="/android/block-app/edit-general">
                              <Edit boxSize={6} mr="5px" />
                              <FormattedMessage id="block_application.edit_config" />
                            </Link>
                          </MenuItem>
                          <MenuItem
                            color="red.500"
                          ...
                          >
                            ...
                            <FormattedMessage id="block_application.remove_config" />
                          </MenuItem>
                        </MenuList>
                      </Menu>
                    </>
