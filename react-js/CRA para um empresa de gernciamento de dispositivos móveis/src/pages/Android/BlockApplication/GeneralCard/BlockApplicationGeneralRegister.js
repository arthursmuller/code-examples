      ...
      <Card>
        ...
        <Box mt="3%">
          <Text m="0% 0% 1% 0%" fontWeight="600">
            <FormattedMessage id="block_application.config_rule" />
          </Text>
          <Divider orientation="horizontal" mb="1.5%" />
          <Box d="flex" flexDirection="row">
            <FormControl w="100%">
              <FormLabel fontSize="sm" color="gray.500">
                <FormattedMessage id="block_application.rule_type" />
              </FormLabel>
              <Box d="flex" flexDirection="row">
            ...
            <FormControl w="100%" ml="25px">
              <FormLabel fontSize="sm" color="gray.500">
                <FormattedMessage id="block_application.select_action" />
              </FormLabel>
              <Box d="flex" flexDirection="row">
        ...
        <ModalContent w="424px" h="363px">
          ...
          <ModalBody d="flex" flexDirection="column" alignItems="center">
            <Text
              ...
              textAlign="center"
            >
              <FormattedMessage id="block_application.modal.confirm_rule" />
            </Text>
            <Text fontWeight="normal" fontSize="sm" mt="10px" color="black.500">
              <div
                dangerouslySetInnerHTML={{
                  __html: intl.formatMessage({
                    id: 'block_application.modal.new_rule_question',
                  }),
                }}
              />
            </Text>
          ...
          <ModalFooter d="flex" flexDirection="column" alignSelf="center">
            ...
            <Box d="flex" flexDirection="row">
              <Box mr="14px">
                ...
                >
                  <FormattedMessage id="block_application.modal.new_rule" />
                </Button>
              </Box>
              <Box>
                <Button
...
export default RegisterGeneralRule;
