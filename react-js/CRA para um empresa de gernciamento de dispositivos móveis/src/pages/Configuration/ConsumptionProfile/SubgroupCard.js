...
const SubgroupsCard = ({ subgroups }) => {
  const { showToaster: toaster, subgroups: subgroupsList } = subgroups;
  ...
  const columns = React.useMemo(
    () => [
      ...
      {
        Header: intl.formatMessage({
          id: 'consumption_profile.general.data_roaming',
        }),
        accessor: 'roaming_data',
      },
      {
        Header: intl.formatMessage({
          id: 'consumption_profile.general.sms',
        }),
        accessor: 'sms',
      },
      {
        Header: intl.formatMessage({
          id: 'consumption_profile.general.sms_roaming',
        }),
  ...
  const { getTableProps, getTableBodyProps, headerGroups, rows, prepareRow } =
    useTable({ columns, data: subgroupsList }, useSortBy);
    ...
    <>
      ...
      >
        <Text color="#00c3af" m="0px 0px 0px 2%">
          ...
          <FormattedMessage id="consumption_profile.group.register_success" />
        </Text>
        <CloseIcon
          boxSize={4}
      ...
      >
        ...
        <Box alignSelf="center">
          ...
          <Button colorScheme="blue" h="45px" w="176px">
            <Link to="/consumption-profile-subgroups-register">
              <FormattedMessage id="global.register_rule" />
            </Link>
          </Button>
        </Box>
      </Box>
                      ...
                      <Menu placement="top" onClose={() => changeColor(-1)}>
                        ...
                        <MenuList>
                          <MenuItem fontSize="sm">
                            <Link to="/consumption-profile-subgroups-edit">
