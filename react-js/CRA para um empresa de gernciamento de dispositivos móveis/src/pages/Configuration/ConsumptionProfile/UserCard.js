...
const UserCard = ({ users }) => {
  const { showToaster: toaster, users: usersList } = users;
  ...
  const { getTableProps, getTableBodyProps, headerGroups, rows, prepareRow } =
    useTable({ columns, data: usersList }, useSortBy);
      ...
      >
        ...
        <Box alignSelf="center">
          ...
          <Button colorScheme="blue" h="45px" w="176px">
            <Link to="/consumption-profile-users-register">
                      ...
                      <Menu placement="top" onClose={() => changeColor(-1)}>
                        ...
                        <MenuList>
                          <MenuItem fontSize="sm">
                            <Link to="/consumption-profile-user-edit">
