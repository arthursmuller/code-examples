...
const GroupsCard = ({ groups }) => {
  const { showToaster: toaster, groups: groupsList } = groups;
  ...
  const { getTableProps, getTableBodyProps, headerGroups, rows, prepareRow } =
    useTable({ columns, data: groupsList }, useSortBy);
    ...
    <>
      ...
      >
        ...
        <Box alignSelf="center">
          ...
          <Button color="blue.500" variant="link" mr="40px" fontWeight="normal">
            <Copy boxSize={6} />
            <FormattedMessage id="global.select_group" />
          </Button>
          <Button colorScheme="blue" h="45px" w="176px">
            <Link to="/consumption-profile-groups-register">
                      ...
                      <Menu placement="top" onClose={() => changeColor(-1)}>
                        ...
                        <MenuList>
                          <MenuItem fontSize="sm">
                            <Link to="/consumption-profile-groups-edit">
