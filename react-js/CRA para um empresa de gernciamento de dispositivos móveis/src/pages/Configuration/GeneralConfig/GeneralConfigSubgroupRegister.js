...
import { createSubgroup } from '../../../store/generalConfig';
import { history } from '../../../store/history';

const GeneralConfigSubgroupRegister = () => {
  const intl = useIntl();
  ...
  return (
    <>
      <Box>
        <Heading>
          <FormattedMessage id="general_config.register.subgroup.title" />
        </Heading>
        <Text width="90%">
...
export default GeneralConfigSubgroupRegister;
