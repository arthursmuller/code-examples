...
import { createGroup } from '../../../store/generalConfig';
import { history } from '../../../store/history';

const GeneralConfigGroupRegister = () => {
  const intl = useIntl();
  ...
  return (
    <>
      <Box>
        <Heading>
          <FormattedMessage id="general_config.register.group.title" />
        </Heading>
        <Text width="90%">
...
export default GeneralConfigGroupRegister;
