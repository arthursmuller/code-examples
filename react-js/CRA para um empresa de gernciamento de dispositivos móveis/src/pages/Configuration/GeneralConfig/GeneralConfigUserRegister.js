...
import { createUser } from '../../../store/generalConfig';
import { history } from '../../../store/history';

const GeneralConfigUserRegister = () => {
  const intl = useIntl();
  ...
  return (
    <>
      <Box>
        <Heading>
          <FormattedMessage id="general_config.register.user.title" />
        </Heading>
        <Text width="90%">
...
export default GeneralConfigUserRegister;
