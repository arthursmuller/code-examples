...
import { updateSubgroup } from '../../../store/generalConfig';
import { history } from '../../../store/history';

const GeneralConfigSubgroupEdit = () => {
  const intl = useIntl();
  ...
  return (
    <>
      <Box>
        <Heading>
          <FormattedMessage id="general_config.edit.subgroup.title" />
        </Heading>
        <Text width="90%">
...
export default GeneralConfigSubgroupEdit;
