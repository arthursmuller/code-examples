...
import { updateUser } from '../../../store/generalConfig';
import { history } from '../../../store/history';

const GeneralConfigUserEdit = () => {
  const intl = useIntl();
  ...
  return (
    <>
      <Box>
        <Heading>
          <FormattedMessage id="general_config.edit.user.title" />
        </Heading>
        <Text width="90%">
...
export default GeneralConfigUserEdit;
