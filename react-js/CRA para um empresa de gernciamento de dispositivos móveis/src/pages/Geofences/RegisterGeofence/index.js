...
import { createGeofence } from '../../../store/geofence';
import { history } from '../../../store/history';

const RegisterGeofence = () => {
  ...
  return (
    <>
      <Box>
        <Heading>
          <FormattedMessage id="geofence.register_title" />
        </Heading>
        <Text width="90%">
          <FormattedMessage id="geofence.register_description" />
        </Text>
      </Box>
      <Card>
...
export default RegisterGeofence;
