...
function MonthlyClusterBarChartUsers({ data }) {
          ...
          legends={[
            {
              ...
              data: data.keys.map((id, index) => ({
                ...
                id,
                label:
                  id === 'newUsers' ? 'Novos usuaios' : 'Total de usuarios',
              })),
              anchor: 'bottom-left',
              direction: 'row',
              justify: false,
...
MonthlyClusterBarChartUsers.propTypes = propTypes;
export default MonthlyClusterBarChartUsers;
